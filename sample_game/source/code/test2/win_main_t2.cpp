...
int WINAPI WinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int iCmdShow) {
	...
	const char* wnd_title = "Sample window t2";									
	...
	//rs = std::make_unique<rd3d9b_tri>();	
	//rs = std::make_unique<rd3d9c_tri>();	
	//rs = std::make_unique<rd3d10_tri>();	
	//rs = std::make_unique<rgl2_tri>();
	rs = std::make_unique<rd3d11_tri>();	
	//rs = std::make_unique<rgl4_tri>();	
