...
#include "ew_fw/fw_lib.h"
#include "ew_fw/fw_internal.h"
...
int WINAPI WinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int iCmdShow) {
	...
	int width = 800;
	int height = 450;
	const char* wnd_title = "Sample window fw";	
	...
	std::unique_ptr<rfglfw_gl2> rs;		
	rs = std::make_unique<rfglfw_gl2>();	
