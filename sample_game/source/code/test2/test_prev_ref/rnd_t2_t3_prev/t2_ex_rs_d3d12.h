...
inline HRESULT ReadDataFromFile(const char* filename, byte** data, UINT* size) {
	sdf::wstring_st<MAX_STR_PATH_OS> file_namew;
	sdf::string_st_wcs_from_mbs(file_namew, filename, sdf::strfz_len(filename));
	...
	Microsoft::WRL::Wrappers::FileHandle file(CreateFile2(file_namew.c_str(), GENERIC_READ, FILE_SHARE_READ, OPEN_EXISTING, &extendedParams));
#else
...
inline bool d3d12_compile_shader_from_file(const char* shader_filename, const char* sh_entry_point, const char* shader_model, ID3DBlob** out_blob) {
    ...
    *out_blob = nullptr;
    ...
    hr = D3DCompileFromFile(shader_file_namew.c_str(), defines, D3D_COMPILE_STANDARD_FILE_INCLUDE, sh_entry_point, shader_model, shader_flags, 0, &shader_blob, &compilation_errors);
...
public: 
	...
	bool init_r(HINSTANCE hinstance, HWND hwnd, int width, int height, bool fullscreen) {
		...
		sys_win_title_append(hwnd, " : Direct3D12");
...
class rd3d12_tri_color : public rd3d12  {
public:		
    ...
    void create_pipeline_state() {
        ...
        load_shaders_file(RS_SHADER_PATH2("d3d12_mss/05_HelloConstBuffers.hlsl"), &vertexShader, &pixelShader);
...
//===============================================================================================
class rd3d12_tri_color_tex : public rd3d12  {
public:		
    // textures
    ...
    void LoadAssets()
    {
        ...
        // Create the pipeline state, which includes compiling and loading shaders.
        {
            ...
            load_shaders_file(RS_SHADER_PATH2("d3d12_mss/03_HelloTexture.hlsl"), &vertexShader, &pixelShader);
...
class rd3d12_tri_color_bundles : public rd3d12  {
public:	
    // Pipeline objects.
    ...
    void LoadAssets()
    {
        ...
        // Create the pipeline state, which includes compiling and loading shaders.
        {
            ...
            load_shaders_file(RS_SHADER_PATH2("d3d12_mss/04_HelloBundles.hlsl"), &vertexShader, &pixelShader);
...
class rd3d12_tri_const_framebuffers : public rd3d12  {
public:	
    ...
    void LoadAssets()
    {
        ...
        // Create the pipeline state, which includes compiling and loading shaders.
        {
            ...
            load_shaders_file(RS_SHADER_PATH2("d3d12_mss/06_HelloFrameBuffering.hlsl"), &vertexShader, &pixelShader);
